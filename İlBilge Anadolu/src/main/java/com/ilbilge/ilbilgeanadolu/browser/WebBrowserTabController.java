...
import main.java.com.ilbilge.ilbilgeanadolu.marquee.FXMarquee;
...
//		searchEngineComboBox.getItems().addAll("Google", "DuckDuckGo", "Bing", "Yahoo","İlBilge");
//		searchEngineComboBox.getSelectionModel().select(1);
		...
		about.setOnAction(a -> {
			...
			alert.setTitle("İlBilge Anadolu Hakkında");
			alert.setHeaderText(null);
			alert.setContentText("Anadolu Versiyon : " + WebBrowserController.VERSION + "\n" + "İlBilge Anadolu Web Tarayıcı");
...
//				return "https://search.yahoo.com";
	...
	public String getSelectedEngineHomeUrl() {
		return getSearchEngineHomeUrl("www.ilbilge.com");
	}
	...
	public void loadWebSite(String webSite) {
		...
		try {
			...
			if (searchBar.getText().isEmpty())
				...
				finalWebsiteSecondPart = "/ara.php?url=" + URLEncoder.encode(searchBar.getText(), "UTF-8");
	...
	void checkForInternetConnection() {
		...
		Thread thread = new Thread(() -> {
			boolean hasInternet = InfoTool.isReachableByPing("www.ilbilge.com");
			Platform.runLater(() -> {
